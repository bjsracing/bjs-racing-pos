// src/pages/LaporanProdukPilok.jsx
...
// Kode ini sekarang hampir identik dengan LaporanProdukTerlaris,
// hanya berbeda di pemanggilan RPC dan judul halaman.

function LaporanProdukPilok() {
  ...
  const fetchReportData = useCallback(async (startDate, endDate) => {
    ...
    setLoading(true);
    try {
      // Panggil fungsi yang sama, tapi dengan filter kategori 'Pilok'
      const { data, error } = await supabase.rpc("get_best_selling_products", {
        start_date: new Date(startDate).toISOString(),
        end_date: new Date(endDate).toISOString(),
        category_filter: "Pilok", // <-- Perbedaan utama ada di sini
      });
...
export default LaporanProdukPilok;
